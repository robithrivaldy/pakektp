...
class PulsaNominalPage extends StatefulWidget {
  const PulsaNominalPage({Key? key}) : super(key: key);

  @override
  _PulsaNominalPage createState() => _PulsaNominalPage();
}

class _PulsaNominalPage extends State<PulsaNominalPage> {
  @override
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: NominalCard(
                      NominalModel(
                        id: 1,
                        name: 'Pulsa ‘Jenis Operator’ 1000',
                        description: 'Masa aktif selama 1 hari',
                        price: 1500,
                      ),
                    ),
                  ),
