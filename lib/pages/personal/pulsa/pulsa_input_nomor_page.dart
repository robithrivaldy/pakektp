...
class PulsaInputNomorPage extends StatefulWidget {
  const PulsaInputNomorPage({Key? key}) : super(key: key);

  @override
  _PulsaInputNomorPage createState() => _PulsaInputNomorPage();
}

class _PulsaInputNomorPage extends State<PulsaInputNomorPage> {
  @override
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.pushNamed(context, '/pulsa-nominal');
                    },
                    child: RecentNoCard(
                      RecentNoModel(
                        id: 1,
