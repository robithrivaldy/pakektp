...
class MitraWarungPage extends StatefulWidget {
  const MitraWarungPage({Key? key}) : super(key: key);

  @override
  _MitraWarungPage createState() => _MitraWarungPage();
}

class _MitraWarungPage extends State<MitraWarungPage> {
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, '/mitra-warung-add-location');
                              },
                              child: Image.asset(
