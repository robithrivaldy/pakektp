...
class PaketDataNominalPage extends StatefulWidget {
  const PaketDataNominalPage({Key? key}) : super(key: key);

  @override
  _PaketDataNominalPage createState() => _PaketDataNominalPage();
}

class _PaketDataNominalPage extends State<PaketDataNominalPage> {
  @override
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: NominalCard(
                      NominalModel(
                        id: 1,
                        name: 'Paket data 30GB untuk 30 hari',
                        description:
                            'Untuk dipakai di jaringan 4G selama full 24 jam',
                        price: 30500,
                      ),
                    ),
                  ),
