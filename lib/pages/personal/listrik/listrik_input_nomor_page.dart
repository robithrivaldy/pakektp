...
class ListrikInputNomorPage extends StatefulWidget {
  const ListrikInputNomorPage({Key? key}) : super(key: key);

  @override
  _ListrikInputNomorPage createState() => _ListrikInputNomorPage();
}

class _ListrikInputNomorPage extends State<ListrikInputNomorPage> {
  @override
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.pushNamed(context, '/listrik-nominal');
                    },
                    child: RecentNoCard(
                      RecentNoModel(
                        id: 1,
                        noPelanggan: '1234567890',
