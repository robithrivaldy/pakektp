...
class DonasiNotificationPage extends StatefulWidget {
  const DonasiNotificationPage({Key? key}) : super(key: key);

  @override
  _DonasiNotificationPage createState() => _DonasiNotificationPage();
}

class _DonasiNotificationPage extends State<DonasiNotificationPage> {
  @override
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(),
                      child: Text(
                        'Kamu akan membayar donasi, Sebesar',
                        style: khulaTextStyle.copyWith(
                          fontWeight: FontWeight.w600,
                          fontSize: 18,
                          color: blackColor,
