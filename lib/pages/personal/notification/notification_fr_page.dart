...
class NotificationFrPage extends StatefulWidget {
  const NotificationFrPage({Key? key}) : super(key: key);

  @override
  _NotificationFrPage createState() => _NotificationFrPage();
}

class _NotificationFrPage extends State<NotificationFrPage> {
