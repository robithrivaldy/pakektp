...
class PascabayarInputNomorPage extends StatefulWidget {
  const PascabayarInputNomorPage({Key? key}) : super(key: key);

  @override
  _PascabayarInputNomorPage createState() => _PascabayarInputNomorPage();
}

class _PascabayarInputNomorPage extends State<PascabayarInputNomorPage> {
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.pushNamed(
                          context, '/pascabayar-rincian-tagihan');
                    },
                    child: RecentNoCard(
                      RecentNoModel(
                        id: 1,
