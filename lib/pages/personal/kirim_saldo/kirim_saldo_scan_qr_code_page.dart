...
class KirimSaldoScanQrCodePage extends StatefulWidget {
  const KirimSaldoScanQrCodePage({Key? key}) : super(key: key);

  @override
  _KirimSaldoScanQrCodePage createState() => _KirimSaldoScanQrCodePage();
}

class _KirimSaldoScanQrCodePage extends State<KirimSaldoScanQrCodePage> {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Gambar tidak akan disimpan\nPusatkan Pola QR Code kedalam bingka',
                              style: khulaTextStyle.copyWith(
                                fontSize: 14,
                                fontWeight: FontWeight.w600,
                                color: whiteColor,
